...
tools:
  ...
  - "Edit"
  - "Write"
  - "Agent(analyst-agent, designer-agent, reader-agent, retrieval-audit, ui-verification, telemetry-audit, contract-audit, docs-spec-sync, automation-governance, terminology-consistency-audit)"
skills:
  - "doc"
  - "playwright"
  - "agent-telemetry"
