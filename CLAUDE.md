...
Этот файл является короткой точкой входа для `claude` и генерируется автоматически.

## Канон правил
- Канонический файл правил: `AGENTS.md`.
...
## Политика UI-ссылок
- Использовать semantic ids из `ops-web/src/generated/ui-section-contract.json`.
